            ...
            <form className="space-y-4 md:space-y-6">
              <div>
                ...
                <input
                  ...
                  id="email"
                  className="bg-gray-50 border border-gray-300 text-gray-900 rounded block w-full dark:placeholder-gray-400 dark:text-black dark:placeholder:text-black input input-sm"
              ...
              <button
                ...
                onClick={handleLogin}
                disabled={loading}
                className={`w-full rounded-md btn-sm text-sm px-5 text-center btn no-animation disabled:bg-slate-900`}
              >
                <span
